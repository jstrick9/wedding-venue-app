...
## Status
- ✅ **Claimed-venue reissue + invite lookup SQL (#207, 2026-08-24)** — `SELECT vai INTO row` crashed lookup with a uuid syntax error; reissue/accept now work when the venue already has an owner. Apply **`supabase/migrations/0016_reissue_claimed_venue_and_invite_lookup.sql`**. Full report: **`docs/reviews/207-claimed-venue-reissue-and-invite-lookup-2026-08-24.md`**.
